...
def message(self, update, context):
    ...
    rm, bot_message, self.meta_conversation, self.stage, self.call, self.entity = reply_message(turn['user_messages'], num_samples, 
        self.model, self.tokenizer, history, self.config, self.mmi_model, 
        self.mmi_tokenizer, self.meta_conversation, self.stage, self.call, self.entity, 
